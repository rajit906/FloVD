...
from flovd.models.transformer_temporal import TransformerSpatioTemporalModelPoseCond
...
def get_up_block(
    ...
    if up_block_type == "UpBlockSpatioTemporal":
        ...
        # added for SDV
        if cross_attention_dim is None:
            raise ValueError("cross_attention_dim must be specified for CrossAttnUpBlockSpatioTemporalPoseCond")
